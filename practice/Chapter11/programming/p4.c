...
void read_card(int num_in_ranks[], int num_in_suits[]);
void analyze_card(int num_in_ranks[], int num_in_suits[], int *straight, int *flush, int *four, int *three, int *pairs);
void print_class(int *straight, int *flush, int *four, int *three, int *pairs);
...
int main(){
	...
	while(1){
		...
		read_card(num_in_ranks, num_in_suits);
		analyze_card(num_in_ranks, num_in_suits, &straight, &flush, &four, &three, &pairs);
		print_class(&straight, &flush, &four, &three, &pairs);
